...
namespace _03_Operators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int intMoney = (int)myMoney; //5 (lose precision of casting)
            ...
            int intTwo = Convert.ToInt32(decimalTwo); // rounds to 3 (does not lose as much precision)

            //Parsing - Specific for Strings
